...
beautiful.init("/home/qq/.config/awesome/theme/theme.lua")
...
globalkeys = awful.util.table.join(
    ...
    awful.key({   }, "#123", function() volume_up() end),
    awful.key({   }, "#122", function() volume_down() end),
    awful.key({   }, "#121", function() volume_mute() end),
